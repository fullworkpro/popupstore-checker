...
PopStore Platform 面向农业产业园的「快闪店 / 农产品成熟期调度」业务，提供三端协同：

- **管理后台**：园区运营人员维护快闪店、查看爬虫采集与调度数据；
- **微信小程序**：C 端用户浏览快闪店、活动详情、收藏店铺；
- **后端服务**：统一管理后台与小程序的数据接口、多平台内容采集、图片代理与鉴权。

目标：让非技术人员也能在 NAS 上一键部署、自托管一套完整的快闪店运营系统。
